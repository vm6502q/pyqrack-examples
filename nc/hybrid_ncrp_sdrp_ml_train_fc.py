...
# Train
# ─────────────────────────────
def train_repair(widths=[4], depth_factor=1, samples_per_width=96, epochs=256, lr=1e-3):
...
if __name__ == "__main__":
    ...
    model = train_repair(widths=[4], depth_factor=1, samples_per_width=96, epochs=256)
