...
# Train
# ─────────────────────────────
def train_repair(widths=[2, 3, 4], depth_factor=1, samples_per_width=80, epochs=144, lr=1e-3):
...
if __name__ == "__main__":
    ...
    model = train_repair(widths=[2, 3, 4], depth_factor=1, samples_per_width=80, epochs=144)
