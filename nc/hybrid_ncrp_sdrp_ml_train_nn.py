...
# Train
# ─────────────────────────────
def train_repair(widths=[6, 8, 9], depth_factor=1, samples_per_width=30, epochs=128, lr=1e-3):
...
if __name__ == "__main__":
    ...
    model = train_repair(widths=[4], depth_factor=1, samples_per_width=30, epochs=128)
