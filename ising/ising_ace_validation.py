...
def main():
    ...
    c_0 = 1.75
    bias_0_shots = int(shots * c_0 / n_qubits)
    bias_1_shots = int(shots * c_0 / 2) // n_qubits
    bias_2_shots = n_qubits * (int(shots * c_0 / 4) // nq_2)
    bias_3_shots = nq_2 * (int(shots * c_0 / 8) // nq_3)
